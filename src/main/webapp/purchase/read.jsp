	...
	<div class="col">
		...
		<table class="table">
			<c:forEach items="${array}" var="gvo">
				<tr>
					<td><a href="/goods/read?gid=${gvo.gid}">${gvo.gid}</td>
